<div class="lastMonth1">
    <div class="InOutflow">
        ...
        <?php
        $sqlSumMoney = "SELECT sum(money) as 'Tong', spend_day FROM spending sp, groups g, users u where sp.group_id = g.group_id AND sp.user_id = u.user_id AND u.user_name = '$username' AND sp.spend_day like '$lastmonth1%' group by MONTH(spend_day)";
    ...
    <?php
    $CurrentDay = 0;
    $sql1 = "SELECT sum(money) as 'Tong', spend_day FROM spending sp, groups g, users u where sp.group_id = g.group_id AND sp.user_id = u.user_id AND u.user_name = '$username' AND sp.spend_day like '$lastmonth1%' group by spend_day order by spend_day desc";
